			...
			<div style="display: flex">
				...
				<div style="width: 45%; margin-right: 9.9%; margin-left: 9.9%; margin-top: 2%;">
					<table id="boardTable" class="table" align="center" style="margin: 0 auto;">
						...
						<tr>
							<td style="border-top: 0;"><img src="img/worldwide.png" style="margin-left: 1px; margin-right: 15px; width:22px; height: 22px;"><span style="color: grey">Korea</span></td>
						</tr>
						<tr>
							<td style="border-top: 0;"><img src="img/gamecontroller.png" style="margin-right: 14px;"><span style="color: grey">${streamerInfo.strGameCategory }</span></td>
						</tr>
						<tr>
