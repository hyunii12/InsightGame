...
<body>
	...
	<div class="container">
		<div style="position: relative; left: 0px; top: 50px; width: 50%;">
		...
		<div style="position: relative; left: 49%; top: -33px; width: 50%;">
	...
	<div style="position: relative; left: 0px; top: 50px; width: 100%; padding-top: 30px;">
		<style>
.faq-cat-content {
	margin-top: 25px;
}
				...
				<div class="col-md-12 col-md-offset-3">
					...
					<ul class="nav nav-tabs faq-cat-tabs nav-pills">
						<li class="nav-item"><a class="nav-link active"
							href="#faq-cat-1" role="tab" data-toggle="tab">히스토리</a></li>
						<li class="nav-item"><a href="#faq-cat-2" class="nav-link"
							role="tab" data-toggle="tab">뉴스기사</a></li>
						<li class="nav-item"><a href="#faq-cat-2" class="nav-link"
							role="tab" data-toggle="tab">프리뷰/리뷰</a></li>
						<li class="nav-item"><a href="#faq-cat-2" class="nav-link"
							role="tab" data-toggle="tab">스크린샷</a></li>
						<li class="nav-item"><a href="#faq-cat-2" class="nav-link"
							role="tab" data-toggle="tab">동영상</a></li>
						<li class="nav-item"><a href="#faq-cat-2" class="nav-link"
							role="tab" data-toggle="tab">공략</a></li>
					</ul>
					<!-- Tab panes -->
