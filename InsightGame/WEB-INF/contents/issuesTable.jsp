...
@media screen and (max-width: 700px) {
	...
	td:not(:first-child){clear:both;margin-left:100px;padding:4px20px4px90px;position:relative;text-align:left;}
...
@media screen and (max-width: 500px) {
	...
	td:not(:first-child){margin:0;padding:5px1em;width:100%;}
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					...
					<table class="gameIssuesRank" cellspacing='0'>
						<thead>
							<tr>
								<th colspan="2" scope="row" style="font-weight: bold">이슈 랭킹 (1위 ~ 10위)</th>
								<!-- 				<th style="font-weight:bold">플랫폼</th> -->
								<!-- 				<th style="font-weight:bold">장르</th> -->
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${todayIssuesList }" var="item"
								varStatus="index" begin="0" end="9">
								<tr>
				...
				<div class="carousel-item">
					...
					<table class="gameIssuesRank" cellspacing='0'>
						<thead>
							<tr>
								<th colspan="2" scope="row" style="font-weight: bold">이슈 랭킹 (11위 ~ 20위)</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${todayIssuesList }" var="item"
								varStatus="index" begin="10" end="19">
								<tr>
									<th scope="row" style="font-weight: bold">${index.index + 1}</th>
									<td>${item.title}</td>
								</tr>
