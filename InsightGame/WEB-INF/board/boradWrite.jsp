	...
	<div style="position: relative;">
		<div class="input-group-prepend" id="headerDropbox">
			...
			<div id="headerSelect" class="dropdown-menu">
				...
				<button class="dropdown-item" type="button" value="HEADER1 "
					onclick='setHeader($(this).val())'>게임1</button>
				<button class="dropdown-item" type="button" value="HEADER2 "
					onclick='setHeader($(this).val())'>게임2</button>
				<button class="dropdown-item" type="button" value="HEADER3 "
					onclick='setHeader($(this).val())'>게임3</button>
			</div>
